...
while not rospy.is_shutdown():
    ...
    # 모터 정보 저장
    motor_info,handler_update = handler.handle(handler_info)
    handler_info = handler_update if handler_update!=None else handler_info
    # print("status,",handler_info.laps_count, handler_info.is_done)
